...
<body>
		...
		<div class="container pt-3">
			...
			<div class="row" style="min-height: 100vh; align-items: center; justify-content: center">
				<div class="col-md-5">
					...
					<p id="time" class="fw-bold"><?php echo round(strlen($blog['blog_content']) / 300, 0); ?> min. read</p>
				</div>
				<div class="col-md-7">
					<div class="blog-img">
	...
	<div class="container">
		...
		<div class="title-section mt-5 col-lg-3 col-md-6">
			<div class="card">
				<div class="d-flex my-auto">
					...
					<div class="details my-auto ms-3">
						<p class="text-dark author-name fw-bold"><?php echo $blog["author"]; ?></p>
									...
									<a class="blog-link text-dark" href="blog.php?id=<?php echo $recent_blog['id']; ?>">
										<div class="hover-zoom">
											<img style="object-fit: cover; height: 15rem"
												src="./blog_uploads/<?php echo $recent_blog['blog_img'] ?>" class="w-100 rounded"
												alt="Recent article">
										</div>
									</a>
									<a class="blog-link text-dark" href="blog.php?id=<?php echo $recent_blog['id']; ?>">
									...
									<div class="authors-profile mt-3">
										<div class="d-flex my-auto">
											...
											<div class="details my-auto ms-2" style="padding-top: 10px">
												<p style="font-size: 12px; line-height: 0px" class="fw-bold author-name">
...
?></p>
	...
	console.log(["<?php echo $blog['blog_content'] ?>"])
	</script>
</body>
