					...
					<form action="update.php?id=<?php echo $id ?>" method="POST">
						...
						<div class="col-12 mt-3">
							...
							<div class="md-form md-outline m-0 mb-4">
								<input style="border: 1px solid #000" required type="text" id="title" name="title" class="form-control"
									value="<?php
if (empty($blog_title)) {
...
?>" />
						...
						<div class="col-12 mt-3">
							...
							<div class="md-form md-outline m-0 mb-4">
								<textarea required class="form-control rounded-sm" min="1" max="1000" style="border: 1px solid #000"
									name="content" id="form4Example3" rows="4"><?php
